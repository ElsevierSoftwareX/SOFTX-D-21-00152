...
{   1:begin
     tmTs.Add('0=ШАГИ 1 и 2: Выбор базы знаний и шаблона правила)');
     tmTs.Add('1=ШАГ 3: Описание условия');
     tmTs.Add('2=ШАГ 4: Проверка (просмотр) введенных данных');
     tmTs.Add('3=ШАГ 5: Описание действия');
     tmTs.Add('4=ШАГ 6: Проверка (просмотр) введенных данных');
     tmTs.Add('5=ШАГ 6: RVML-схема');
   end; }
  end;  //end case
