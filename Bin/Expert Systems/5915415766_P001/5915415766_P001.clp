...
;Task_Name=P001
;Task_Description=
;Task_Authors=Researcher
;Task_Creation_date=21.11.2016 16:57:13
;Task_Modification_date=10.03.2021 11:09:48
;Task_Ver=1
;Task_Platfotm=Windows / CLIPS-PKBD
;**************************************************************
...
(slot caption-technological-heredity (default "DEFECT OF WELDING")) ;ссылка на технологическую наследственность
...
(slot contents-molecular-hydrogen) ;содержание молекулярного водорода /меньше 10% об/от 10% до 50% об/больше 50 % об/
...
(caption-technological-heredity DEFECT OF WELDING) ;ссылка на технологическую наследственность
)
=>
(assert 
